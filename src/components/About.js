            ...
            <div className="container mx-auto flex px-10 py-20 md:flex-row flex-col items-centre mt-11">
                <div className="lg:flex-grow md:w-1/2 md:mr-10 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
                    ...
                    <div className="flex justify-centre">
                        <a
                            href="#contact"
                            className="inline-flex  bg-euc text-greyText border-0 py-2 px-6 focus:outline-none hover:bg-darkEuc hover:text-euc rounded text-lg">
                                work with me
                        </a>
                        <a
                            href="#projects"
                            className="ml-4 inline-flex text-greyText bg-euc border-0 py-2 px-6 focus:outline-none hover:bg-darkEuc hover:text-euc rounded text-lg">
                                See my past work.
                            </a>
                    </div>
                </div>
